 ...
 <div class="row">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <?= form_open_multipart('admin/tambahtugasnya'); ?>
...
<div class="form-group row">
    <div class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    <input required type="text" style="color: black" class="form-control" id="nama_matkul" name="nama_matkul" >
    ...
    <textarea class="form-control" name="penjelasan_tugas" id="penejelasan_tugas" rows="5"></textarea>
    <?= form_error('penjelasan_tugas', '<small class="text-danger pl-3">', '</small>'); ?>
                ...
                <div class="row">
                  ...
                  <input style="color: black" required type="datetime-local" class="form-control" id="tgl_mulai" name="tgl_mulai"  >
               ...
               <input style="color: black" required type="datetime-local" class="form-control" id="tgl_terakhir" name="tgl_terakhir" >
...
<p class="mt-4" style="color: red; font-size: 10px">Gunakan File .docx atau .pdf, maximal 5 Mb</p>
  ...
  <button type="submit" class="btn btn-primary mt-3" style="padding-left: 50px; padding-right: 50px ">Tambah Tugas</button>
